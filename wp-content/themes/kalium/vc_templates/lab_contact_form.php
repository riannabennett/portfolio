...
<div class="<?php echo esc_attr($css_class) . vc_shortcode_custom_css_class($css, ' '); ?>">
	<form action="#" class="contact-form" id="<?php echo esc_attr($uniqid); ?>" data-check="<?php echo esc_attr($check_string); ?>" novalidate>
		...
		<div class="row">
    		<div class="col-sm-6">
				<div class="form-group absolute">
					...
					<?php endif; ?>
					<input name="name" id="<?php echo "{$uniqid}_name"; ?>" type="text" placeholder="">
				</div>
    		</div>
			<div class="col-sm-6">
				<div class="form-group absolute">
					...
					<?php endif; ?>
					<input name="email" id="<?php echo "{$uniqid}_email"; ?>" type="email" placeholder="">
				</div>
			</div>
    		...
    		<div class="col-sm-12">
				<div class="form-group absolute">
					...
					<?php endif; ?>
					<input name="subject" id="<?php echo "{$uniqid}_subject"; ?>" type="text" placeholder="">
				</div>
    		</div>
			<?php endif; ?>
			...
			<div class="col-sm-12">
				<div class="form-group">
					...
					<?php endif; ?>
					<textarea name="message" id="<?php echo "{$uniqid}_message"; ?>" placeholder=""></textarea>
				</div>
			</div>
		</div> <!-- row -->
