		...
		<?php
			...
			if ( '' != $order->customer_note ) { ?>
				<tr>
					<?php # start: modified by Arlind Nushi ?>
					<td colspan="2">
						<div class="order-note-title"><?php _e( 'Note:', 'woocommerce' ); ?></div>
						<div class="order-note-description"><?php echo wptexturize( $order->customer_note ); ?></div>
					</td>
...
<?php # start: modified by Arlind Nushi ?>
<header>
	<h3 class="my-account-sub-title"><?php _e( 'Customer details', 'woocommerce' ); ?></h3>
</header>
<?php # end: modified by Arlind Nushi ?>
