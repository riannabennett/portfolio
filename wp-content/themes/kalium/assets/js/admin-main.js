;(function($, window, undefined)
{
	...
	$(document).ready(function()
	{
		...
		{	
			...
			if(is_editing)
			{
				$warning_container.append('<strong>Note:</strong> You are currently using <strong>'+default_text+'</strong> type. If you change this portfolio type you may loose the current settings.');
			}
			else
			{
